...
@section('content')
<div class="container"  style="margin-top: calc(20% - 200px)">
    <div class="row justify-content-center">
        <div class="col-md-8">

            <h1 style="border: 30px solid #000; padding: 25px"> <a href="/">{{ $questionnaire->title }}</a> </h1>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="survey[mobile]" type="text" class="form-control" id="mobile" aria-describedby="mobileHelp" placeholder="Enter Mobile Number">
                            <small id="nameHelp" class="form-text text-muted">Hello! What's your Mobile Number?</small>
